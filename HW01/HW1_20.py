...
train_df.iloc[:, [38, 39, 54, 55, 70, 71, 86, 87, 102, 103]] = train_df.iloc[:, [38, 39, 54, 55, 70, 71, 86, 87, 102, 103]]*10
train_df.iloc[:, [53, 69, 85, 101]] = train_df.iloc[:, [53, 69, 85, 101]]*15

test_df = pd.read_csv('./covid.test.csv')
test_df.iloc[:, [38, 39, 54, 55, 70, 71, 86, 87, 102, 103]] = test_df.iloc[:, [38, 39, 54, 55, 70, 71, 86, 87, 102, 103]]*10
test_df.iloc[:, [53, 69, 85, 101]] = test_df.iloc[:, [53, 69, 85, 101]]*15
...
config = {
    'seed': 37,      # Your seed number, you can pick your lucky number. :)
